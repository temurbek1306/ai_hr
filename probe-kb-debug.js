...
async function debugFinal() {
    ...
    const empEmail = `kb_final_${timestamp}@test.com`;
    ...
    try {
        ...
        console.log('User /me Keys:', Object.keys(meRes.data.body || {}));
        console.log('User /me Body content (partial):', JSON.stringify(meRes.data.body, null, 2));

        console.log('--- 6. Fetch /me/summary ---');
        const summaryRes = await axios.get(`${BASE_URL}/api/v1/employees/me/summary`, {
            headers: { Authorization: `Bearer ${empToken}` }
        });
        console.log('User /me/summary Keys:', Object.keys(summaryRes.data.body || {}));
        console.log('User /me/summary VideoUrl:', summaryRes.data.body.videoUrl || 'MISSING');
